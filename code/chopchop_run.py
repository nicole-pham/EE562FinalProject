...
read_prefix= r'/home/nicole/Gitlab/School/ee562/fast_scnn/data/Potsdam/'
prefix_imgs = r'2_Ortho_RGB/'
...
def ID_2_filenames(_ID):
    ...
    img_name = r'top_potsdam_'+_ID + '_RGB.tif'
...
def read_n_stack(_ID):
    ...
    # read DEMs, don't care about DSM
    '''
...
prefix_global_write = r'/home/nicole/Gitlab/School/ee562/fast_scnn/data/Potsdam_6k/'
...
if __name__ == '__main__':
    ...
    #'''
    nnodes  = int(8) # Change with the number of your CPUs 
